...
-- the Sale Order Number and the Sale Total Due for each order from	the Sales.SalesOrderHeader
-- table that has a sales person listed	on the sale. We	also want to view the sales territory 
-- that each sales	person	is	associated	with	regardless	of	whether	or	
-- not they have a listed sales territory.	
